...
class Arithmetic
{
     ...
     *
     * @param string $number The number which we are truncating decimals of
     ...
     */
    public static function truncateDecimals(string $number, int $places)
    {
