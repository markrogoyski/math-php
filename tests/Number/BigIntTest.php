...
class BigIntTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function dataProviderForDecBin()
    {
        ...
        return [
            ...
            [ // MAX_INT as a 128 bit number (1x63) - testing constructor using a string on a native int
                "9223372036854775807",
                '111111111111111111111111111111111111111111111111111111111111111',
            ],
            [ // MAX_INT + 1 as a 128 bit number (1 . 0x63) - testing string constructor of a number that exceeds a native integer
                "9223372036854775808",
